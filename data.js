...
// ==== AI481 Chapter 3 Advanced Upgrade: Production, Azure, Deployment & Lab Pipeline ====
(function(){
  const D = window.STUDY_DATA;
  if (!D) return;
  const exists = (arr, key, val) => (arr || []).some(x => x && x[key] === val);
  const chapter = {"id": "ch3advanced", "title": "Chapter 3 Advanced \u2014 Production, Azure, Deployment & Lab Pipeline", "tag": "Core Chapter", "priority": "Very High", "summary": "Second-half Chapter 3 audit: production requirements, Azure cloud architecture, AKS, Functions, Event Hub, Cosmos DB, Azure AI Services, Azure OpenAI, Azure ML, MCP integration, lab workflow, API calls, validation, and error handling.", "mustKnow": ["Production = Security + Monitoring + Scalability + Compliance.", "Production pipeline = Input Validation \u2192 Agent \u2192 Monitoring \u2192 Output.", "Azure cloud pipeline = User \u2192 Web App \u2192 API Gateway \u2192 Microservices \u2192 Agent Service \u2192 MCP Layer \u2192 Azure APIs/EHR/DB.", "AKS runs scalable containers; Functions run lightweight event-driven tasks; Event Hub ingests streaming data; Cosmos DB stores NoSQL context/events.", "Azure OpenAI provides LLM reasoning; Azure ML trains and deploys custom models.", "Integration flow: train in Azure ML \u2192 deploy as API \u2192 agent calls via MCP \u2192 use in clinical workflow.", "API call: POST to scoring URI; headers Content-Type + Authorization; body patient features JSON; response prediction/probability/class label.", "Validation/error handling: missing fields, invalid input, endpoint timeout/failure, fallback response."], "concepts": [["Production requirements", "Security, monitoring, scalability, compliance."], ["AKS", "Container orchestration for scalable microservices and agent services."], ["Azure Functions", "Serverless event-driven compute for lightweight tasks."], ["Event Hub", "Real-time high-throughput streaming ingestion."], ["Cosmos DB", "Low-latency NoSQL database for interactions, context, events, memory."], ["Azure OpenAI", "Enterprise LLM API for reasoning and response generation."], ["Azure ML", "Build, train, register, version, deploy ML models and endpoints."], ["Scoring URI", "The URL endpoint used to send prediction requests to a deployed Azure ML model."], ["MCP", "Standardizes agent-to-tool invocation and structured responses."]], "pitfalls": ["Do not confuse Azure OpenAI with Azure ML: OpenAI is for LLM reasoning; Azure ML is for custom model lifecycle.", "Do not confuse Event Hub with Cosmos DB: Event Hub ingests streams; Cosmos DB stores NoSQL data.", "Do not skip validation before API calls in healthcare.", "A lab prototype is not production unless security, monitoring, scalability, and compliance are added."]};
  if (!exists(D.chapters, 'id', 'ch3advanced')) D.chapters.push(chapter);
  const extraServices = [{"name": "Azure AI Services", "memory": "Pre-built AI APIs", "stage": "AI Services", "role": "Provides language, vision, and speech APIs so apps can use AI capabilities without training models from scratch.", "howToDifferentiate": "Think: ready-made AI such as text analytics, speech-to-text, vision, or chatbot features.", "examTrap": "Azure AI Services are pre-built APIs; Azure ML is for custom model training and deployment."}, {"name": "Azure OpenAI Service", "memory": "LLM via API", "stage": "AI Services", "role": "Provides access to LLMs through secure Azure APIs for agent reasoning, planning, and response generation.", "howToDifferentiate": "Think: LLM reasoning inside the agent.", "examTrap": "Do not confuse Azure OpenAI with Azure ML. OpenAI is LLM reasoning; Azure ML is model lifecycle."}, {"name": "Azure Cosmos DB", "memory": "NoSQL context storage", "stage": "Store", "role": "Stores patient interaction data, context, events, and agent memory with low-latency access and global scaling.", "howToDifferentiate": "Think: fast NoSQL database for context/events/memory.", "examTrap": "Cosmos DB stores data; Event Hub ingests streams; Azure ML trains models."}];
  D.azureServices = D.azureServices || [];
  extraServices.forEach(s => { if (!exists(D.azureServices, 'name', s.name)) D.azureServices.push(s); });
  const extraDiagrams = [{"page": 46, "title": "Production Requirements", "description": "Security, monitoring, scalability, and compliance are required to move from prototype to production.", "examTip": "Memorize the four production requirements as a set.", "image": "assets/chapter3-diagrams/ch3_page_46.jpg"}, {"page": 47, "title": "Production Pipeline", "description": "Input Validation \u2192 Agent \u2192 Monitoring \u2192 Output.", "examTip": "Validation happens before the agent; monitoring happens during/after execution.", "image": "assets/chapter3-diagrams/ch3_page_47.jpg"}, {"page": 48, "title": "Azure Cloud Architecture for Agentic AI", "description": "Shows frontend, API gateway, microservices, agent service, MCP layer, Azure APIs, EHR, DB, LLM, tools, memory.", "examTip": "Be able to trace user request to agent and external tools.", "image": "assets/chapter3-diagrams/ch3_page_48.jpg"}, {"page": 49, "title": "Microservices Breakdown", "description": "Auth, Patient, AI Agent, Notification, and Monitoring services divide a healthcare system into manageable units.", "examTip": "Know which service does what.", "image": "assets/chapter3-diagrams/ch3_page_49.jpg"}, {"page": 50, "title": "Azure Cloud for Healthcare AI", "description": "Explains why Azure supports scalable, secure, compliant healthcare AI deployments.", "examTip": "Azure is used for production readiness, not only experimentation.", "image": "assets/chapter3-diagrams/ch3_page_50.jpg"}, {"page": 51, "title": "Azure Kubernetes Service", "description": "AKS runs containers, hosts agents at scale, supports auto-scaling and high availability.", "examTip": "AKS = scalable container hosting.", "image": "assets/chapter3-diagrams/ch3_page_51.jpg"}, {"page": 52, "title": "Azure Functions", "description": "Serverless event-driven compute for lightweight AI tasks triggered by events.", "examTip": "Functions = triggered small tasks.", "image": "assets/chapter3-diagrams/ch3_page_52.jpg"}, {"page": 53, "title": "Azure Event Hub", "description": "Handles real-time data streams from IoT and wearable data and feeds AI pipelines.", "examTip": "Event Hub = streaming ingestion.", "image": "assets/chapter3-diagrams/ch3_page_53.jpg"}, {"page": 54, "title": "Azure Cosmos DB", "description": "NoSQL database for patient interaction data with low-latency global scale.", "examTip": "Cosmos DB = NoSQL context/events storage.", "image": "assets/chapter3-diagrams/ch3_page_54.jpg"}, {"page": 56, "title": "Azure AI Services Overview", "description": "Pre-built AI capabilities for language, vision, and speech APIs.", "examTip": "Use when no custom model training is needed.", "image": "assets/chapter3-diagrams/ch3_page_56.jpg"}, {"page": 58, "title": "Azure OpenAI Service", "description": "LLM API service used for agent reasoning in secure enterprise deployment.", "examTip": "OpenAI = reasoning; Azure ML = custom model lifecycle.", "image": "assets/chapter3-diagrams/ch3_page_58.jpg"}, {"page": 59, "title": "Azure Machine Learning", "description": "Build, train, deploy, track experiments, version models, and run MLOps pipelines.", "examTip": "Azure ML = train/deploy models.", "image": "assets/chapter3-diagrams/ch3_page_59.jpg"}, {"page": 62, "title": "AI + Azure ML + Agents Integration", "description": "Train in Azure ML, deploy as API, agent calls via MCP, use in clinical workflow.", "examTip": "Model predicts, Agent coordinates, LLM explains, Safety validates.", "image": "assets/chapter3-diagrams/ch3_page_62.jpg"}, {"page": 63, "title": "Lab Session Overview", "description": "Build healthcare AI agent end-to-end through agent logic, Azure ML, API deployment, and testing.", "examTip": "Lab mirrors a realistic healthcare AI pipeline.", "image": "assets/chapter3-diagrams/ch3_page_63.jpg"}, {"page": 71, "title": "Lab Prerequisites", "description": "Azure for Students, Azure ML workspace, Python notebook, mock data, REST API basics.", "examTip": "Know what is needed before the lab.", "image": "assets/chapter3-diagrams/ch3_page_71.jpg"}, {"page": 72, "title": "Step 1 \u2014 Build the Agent", "description": "Define task, schema, reasoning logic, and placeholders for tool calls.", "examTip": "Agent design starts with input/output schema.", "image": "assets/chapter3-diagrams/ch3_page_72.jpg"}, {"page": 73, "title": "Agent Design Example", "description": "Input symptoms/age/history; reasoning identifies red flags; tool call sends features to Azure ML; output gives risk/explanation/action.", "examTip": "Great short-answer question.", "image": "assets/chapter3-diagrams/ch3_page_73.jpg"}, {"page": 74, "title": "Step 2 \u2014 Prepare Azure ML Model", "description": "Train/load model, register model, create inference script, define environment dependencies.", "examTip": "Register model before deployment.", "image": "assets/chapter3-diagrams/ch3_page_74.jpg"}, {"page": 75, "title": "Step 2 \u2014 Deploy Azure ML Endpoint", "description": "Create online endpoint, deploy model, obtain scoring URI and authentication key/token.", "examTip": "Endpoint = scoring URI + auth.", "image": "assets/chapter3-diagrams/ch3_page_75.jpg"}, {"page": 76, "title": "Step 3 \u2014 Connect Agent to API", "description": "Use requests/SDK, send JSON payload, receive prediction, parse result.", "examTip": "Body = patient features in JSON.", "image": "assets/chapter3-diagrams/ch3_page_76.jpg"}, {"page": 77, "title": "Sample API Call Structure", "description": "POST to scoring URI with Content-Type and Authorization headers; response has prediction/probability/class label.", "examTip": "Know POST, headers, body, response.", "image": "assets/chapter3-diagrams/ch3_page_77.jpg"}, {"page": 79, "title": "Validation and Error Handling", "description": "Check missing fields, invalid input, endpoint failures/timeouts, fallback response.", "examTip": "Healthcare agents must fail safely.", "image": "assets/chapter3-diagrams/ch3_page_79.jpg"}, {"page": 80, "title": "Lab Architecture Summary", "description": "User input \u2192 Agent \u2192 Azure ML API \u2192 Prediction \u2192 Agent response, with optional EHR/guidelines/alerts.", "examTip": "This is simplified but realistic.", "image": "assets/chapter3-diagrams/ch3_page_80.jpg"}, {"page": 81, "title": "Lab Deliverables", "description": "Agent design diagram, endpoint, API code snippet, workflow demo, reflection.", "examTip": "Deliverables are likely viva/discussion points.", "image": "assets/chapter3-diagrams/ch3_page_81.jpg"}, {"page": 82, "title": "Lab Discussion Questions", "description": "Questions on deployment difficulty, hospital failures, safety checks, and production extension.", "examTip": "Prepare model answers.", "image": "assets/chapter3-diagrams/ch3_page_82.jpg"}];
  D.diagramBank = D.diagramBank || [];
  extraDiagrams.forEach(d => { if (!exists(D.diagramBank, 'page', d.page)) D.diagramBank.push(d); });
  const extraMCQs = [{"q": "Which set best summarizes production requirements for healthcare agentic AI?", "options": ["Security, monitoring, scalability, compliance", "Prompting, creativity, speed, design", "Only LLM, memory, and tools", "Only Azure ML and Power BI"], "answer": 0, "explanation": "The production slide lists security, monitoring, scalability, and compliance.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Why is security a production requirement in healthcare AI?", "options": ["To protect patient data and control access", "To make dashboards colorful", "To replace monitoring", "To avoid using APIs"], "answer": 0, "explanation": "Healthcare AI handles sensitive patient data and needs controlled access.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "What does monitoring mainly do in production?", "options": ["Tracks logs, failures, performance, and system health", "Trains the model from scratch", "Replaces the orchestrator", "Stores all raw medical images"], "answer": 0, "explanation": "Monitoring observes how the system behaves after deployment.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Scalability means the system can:", "options": ["Handle more users, data, and requests without failing", "Avoid using cloud services", "Store only one patient record", "Skip validation"], "answer": 0, "explanation": "Scalability is about growth and load handling.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Compliance in healthcare AI means:", "options": ["Following healthcare regulations, privacy rules, and organizational requirements", "Using the newest LLM only", "Writing shorter prompts", "Avoiding APIs"], "answer": 0, "explanation": "Production healthcare systems must comply with health data rules and policies.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "In the production pipeline, what comes before the agent?", "options": ["Input validation", "Output display", "Dashboard visualization", "Model versioning"], "answer": 0, "explanation": "The pipeline is Input Validation \u2192 Agent \u2192 Monitoring \u2192 Output.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Why is input validation important before calling a clinical model?", "options": ["Wrong or missing patient data may produce unsafe output", "It makes the UI prettier", "It trains the model faster", "It replaces the EHR"], "answer": 0, "explanation": "Validation catches missing fields, invalid values, and unsafe inputs.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Which production step detects endpoint failures or slow responses?", "options": ["Monitoring", "Orchestrator only", "Power Apps", "Patient Service"], "answer": 0, "explanation": "Monitoring tracks failures, timeout, latency, and health.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "A fallback response is used when:", "options": ["The input is invalid, the endpoint fails, or the case is unknown", "The answer is already certain", "No output is needed", "The dashboard loads"], "answer": 0, "explanation": "Fallbacks prevent unsafe or unsupported outputs.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Which production output is safest?", "options": ["Prediction with confidence, explanation, and next action under safety checks", "A diagnosis with no explanation", "A random recommendation", "A hidden model label only"], "answer": 0, "explanation": "Healthcare outputs should be understandable, traceable, and safety-aware.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "In the Azure cloud architecture pipeline, which component usually receives user interaction first?", "options": ["Web App / Frontend", "Cosmos DB", "Event Hub", "Azure ML endpoint"], "answer": 0, "explanation": "The user interacts through a frontend/web app before backend routing.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "What is the role of an API Gateway?", "options": ["Route and manage API requests between frontend and backend services", "Train a neural network", "Store agent memory", "Create Power BI reports"], "answer": 0, "explanation": "API Gateway is part of backend traffic routing and integration.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Which microservice is responsible for login, identity, and permissions?", "options": ["Auth Service", "Patient Service", "Notification Service", "Monitoring Service"], "answer": 0, "explanation": "Auth Service handles authentication and authorization.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Which microservice would retrieve patient age, history, or profile data?", "options": ["Patient Service", "Auth Service", "Notification Service", "Power BI Service"], "answer": 0, "explanation": "Patient Service manages patient data access.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Which microservice runs reasoning, planning, and tool calls?", "options": ["AI Agent Service", "Auth Service", "Cost Service", "Patient Service only"], "answer": 0, "explanation": "AI Agent Service runs the agent workflow.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Which microservice sends alerts or reminders to clinicians?", "options": ["Notification Service", "Cosmos DB", "AKS", "Azure ML"], "answer": 0, "explanation": "Notification Service handles alerting and messages.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Which microservice tracks logs and errors?", "options": ["Monitoring Service", "Auth Service", "Patient Service", "Azure OpenAI only"], "answer": 0, "explanation": "Monitoring Service tracks system behavior.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "In enterprise integration, MCP mainly helps by:", "options": ["Standardizing tool invocation and structured responses", "Replacing all databases", "Training the LLM", "Creating dashboards"], "answer": 0, "explanation": "MCP acts as a standard way for agents to call tools.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Which sequence best represents the full Azure agentic AI architecture?", "options": ["User \u2192 Web App \u2192 API Gateway \u2192 Microservices \u2192 Agent Service \u2192 MCP Layer \u2192 Azure APIs/EHR/DB", "Cosmos DB \u2192 User \u2192 Power BI \u2192 Excel", "Event Hub \u2192 LLM \u2192 No output", "Power BI \u2192 Azure ML \u2192 Patient symptoms"], "answer": 0, "explanation": "This is the architecture described in Chapter 3 advanced slides.", "topic": "Chapter 3 Advanced", "difficulty": "hard"}, {"q": "What is the main role of the orchestrator in this architecture?", "options": ["Coordinate workflow, tools, and execution order", "Store raw data forever", "Only draw charts", "Encrypt passwords only"], "answer": 0, "explanation": "The orchestrator controls planning and routing.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "What is memory used for in an agent service?", "options": ["Context, interactions, intermediate results, and sometimes persistent knowledge", "Only billing", "Only medical imaging", "Only API keys"], "answer": 0, "explanation": "Memory is the context layer of an agent.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Tools in an agentic healthcare system may include:", "options": ["EHR APIs, risk model APIs, drug databases, calculators", "Only PowerPoint slides", "Only manual notes", "Only frontend buttons"], "answer": 0, "explanation": "Tools let the agent interact with external systems.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "AKS is mainly used to:", "options": ["Run containerized microservices and agent services at scale", "Store NoSQL patient interactions", "Receive real-time streams", "Provide LLM reasoning"], "answer": 0, "explanation": "AKS hosts scalable containerized services.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Which Azure service supports auto-scaling and high availability for microservices?", "options": ["Azure Kubernetes Service (AKS)", "Azure Event Hub", "Azure Cosmos DB", "Azure AI Services"], "answer": 0, "explanation": "AKS is the container orchestration service.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Azure Functions are best described as:", "options": ["Serverless event-driven compute for lightweight tasks", "A NoSQL database", "A dashboard tool", "A model registry only"], "answer": 0, "explanation": "Functions run small tasks triggered by events.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "A new patient record arrives and triggers a small processing task. Which service fits best?", "options": ["Azure Functions", "Cosmos DB", "Power BI", "Azure OpenAI"], "answer": 0, "explanation": "Azure Functions are triggered by events such as new patient data.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Azure Event Hub is mainly for:", "options": ["High-throughput real-time data streams", "Training custom ML models", "Creating low-code apps", "Storing secrets"], "answer": 0, "explanation": "Event Hub handles streaming ingestion.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Wearable device data arriving continuously would most likely feed into:", "options": ["Azure Event Hub", "Azure Machine Learning studio only", "Power Apps", "Azure Key Vault"], "answer": 0, "explanation": "Event Hub handles real-time streams from IoT/wearable data.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Azure Cosmos DB is:", "options": ["A low-latency NoSQL database", "A serverless function runtime", "A container orchestrator", "A clinical imaging model"], "answer": 0, "explanation": "Cosmos DB stores NoSQL data with low latency and global scaling.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Which service can store agent context, events, and patient interaction data?", "options": ["Azure Cosmos DB", "Azure Event Hub", "Azure Functions", "Azure OpenAI"], "answer": 0, "explanation": "Cosmos DB is a suitable storage layer for context/events/interactions.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Azure AI Services provide:", "options": ["Pre-built language, vision, and speech APIs", "Only container hosting", "Only NoSQL storage", "Only event ingestion"], "answer": 0, "explanation": "Azure AI Services are pre-built AI capabilities.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "If a healthcare app needs speech-to-text for doctors without training a model, choose:", "options": ["Azure AI Services", "AKS", "Cosmos DB", "Event Hub"], "answer": 0, "explanation": "Speech APIs are pre-built AI services.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Azure OpenAI Service is used for:", "options": ["LLM access through a secure enterprise API", "NoSQL storage", "Device telemetry ingestion", "Power BI visualization"], "answer": 0, "explanation": "Azure OpenAI provides LLMs for reasoning and generation.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "In an agentic AI system, Azure OpenAI most directly supports:", "options": ["Agent reasoning and response generation", "Training a custom risk score model", "Storing logs", "Sending SMS alerts"], "answer": 0, "explanation": "Azure OpenAI supplies LLM capabilities.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Azure Machine Learning is used to:", "options": ["Build, train, register, version, and deploy ML models", "Only ingest streaming data", "Only manage passwords", "Only send notifications"], "answer": 0, "explanation": "Azure ML handles the ML model lifecycle.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Experiment tracking, model versioning, and MLOps pipelines belong mainly to:", "options": ["Azure Machine Learning", "Azure Event Hub", "Azure Functions", "Cosmos DB"], "answer": 0, "explanation": "These are Azure ML lifecycle capabilities.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Which service should you choose for custom disease prediction model deployment?", "options": ["Azure Machine Learning", "Azure AI Services only", "Azure Event Hub", "Cosmos DB only"], "answer": 0, "explanation": "Custom model build/train/deploy is Azure ML.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Azure ML for Healthcare can support:", "options": ["Disease prediction, image classification, risk scoring, personalized treatment", "Only identity management", "Only cost tracking", "Only file uploads"], "answer": 0, "explanation": "These use cases are listed in the Azure ML healthcare slides.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Which pair is correctly matched?", "options": ["Event Hub \u2014 streaming ingestion", "Cosmos DB \u2014 LLM reasoning", "AKS \u2014 model training only", "Azure OpenAI \u2014 device management"], "answer": 0, "explanation": "Event Hub is for real-time streaming ingestion.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Which pair is correctly matched?", "options": ["Cosmos DB \u2014 low-latency NoSQL storage", "Azure Functions \u2014 dashboard visualization", "Event Hub \u2014 model versioning", "AKS \u2014 speech-to-text"], "answer": 0, "explanation": "Cosmos DB stores NoSQL data with low-latency access.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Which service is most associated with containerized production deployment?", "options": ["AKS", "Azure OpenAI", "Azure AI Services", "Event Hub"], "answer": 0, "explanation": "AKS runs containerized services at scale.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Which service is most associated with LLM reasoning in Azure?", "options": ["Azure OpenAI Service", "Cosmos DB", "Event Hub", "Azure Functions"], "answer": 0, "explanation": "Azure OpenAI gives access to LLMs via API.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "What is the correct integration flow for AI + Azure ML + Agents?", "options": ["Train model in Azure ML \u2192 Deploy as API \u2192 Agent calls model via MCP \u2192 Use in clinical workflow", "Agent trains itself \u2192 no API \u2192 no safety", "Power BI trains model \u2192 Event Hub responds", "Cosmos DB predicts disease \u2192 AKS visualizes"], "answer": 0, "explanation": "Chapter 3 states the model is trained/deployed in Azure ML and the agent calls it via MCP.", "topic": "Chapter 3 Advanced", "difficulty": "hard"}, {"q": "In the memory shortcut \u201cModel predicts, Agent coordinates, LLM explains, Safety validates,\u201d what does the model do?", "options": ["Produces prediction/probability/class label", "Controls every workflow step", "Writes UI code", "Stores secrets"], "answer": 0, "explanation": "The model produces the ML output.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "What does the agent do in the Azure ML integration?", "options": ["Coordinates workflow and calls the model API", "Replaces the model", "Acts only as a database", "Only displays charts"], "answer": 0, "explanation": "The agent coordinates actions and tool calls.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "What does the LLM mainly do in the integrated workflow?", "options": ["Reasoning/explanation/response generation under control", "Final clinical authority without validation", "Database storage", "Device management"], "answer": 0, "explanation": "The LLM supports reasoning and natural language output.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "What does the safety layer do in the integrated workflow?", "options": ["Validates and guards against unsafe output", "Replaces Azure ML", "Stores billing data", "Turns streams into dashboards"], "answer": 0, "explanation": "Safety checks protect against hallucination, unsafe recommendations, and privacy issues.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "What is the goal of the lab session?", "options": ["Build a simple healthcare AI agent end-to-end", "Only memorize Azure names", "Build a hospital from scratch", "Replace all clinicians"], "answer": 0, "explanation": "The lab goal is an end-to-end simple healthcare AI agent.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Which is Step 1 of the lab workflow?", "options": ["Build the agent logic", "Deploy Power BI", "Delete validation", "Write a billing report"], "answer": 0, "explanation": "Step 1 is building the agent logic.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Which lab prerequisite is required to use Azure ML?", "options": ["Azure Machine Learning workspace", "Only Microsoft Word", "A physical robot", "No programming environment"], "answer": 0, "explanation": "The lab lists Azure ML workspace as a prerequisite.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "A basic understanding of REST APIs is needed because:", "options": ["The agent calls Azure ML endpoint using API requests", "The exam requires drawing only", "Cosmos DB cannot store data", "Power BI needs no data"], "answer": 0, "explanation": "The agent connects to endpoint via API calls.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "In the agent design example, the input includes:", "options": ["Patient symptoms, age, and history", "Only hospital logo", "Only API key", "Only dashboard color"], "answer": 0, "explanation": "The example input is patient symptoms, age, history.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "In the agent design example, the reasoning step identifies:", "options": ["Red flags and required checks", "Only CSS styles", "Only Azure subscription price", "Only random labels"], "answer": 0, "explanation": "Reasoning identifies red flags and checks before tool calls.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "In the agent design example, the tool call sends features to:", "options": ["Azure ML model", "Power BI chart", "Local printer", "Key Vault as prediction engine"], "answer": 0, "explanation": "The tool call sends features to the Azure ML model.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "The output of the agent design example is:", "options": ["Predicted risk + explanation + next action", "Only raw JSON without explanation", "Only a password", "Only model weights"], "answer": 0, "explanation": "The output combines prediction, explanation, and suggested action.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Which step includes registering the model and creating an inference script?", "options": ["Prepare the Azure ML Model", "Build the frontend menu", "Monitor cost only", "Open the dashboard"], "answer": 0, "explanation": "This belongs to preparing the Azure ML model.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "What do you obtain after deploying an Azure ML endpoint?", "options": ["Scoring URI and authentication key/token", "Only a PDF report", "Only a patient name", "Only a PowerPoint image"], "answer": 0, "explanation": "Endpoint deployment provides URI and authentication details.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "What is sent from the agent to the Azure ML API?", "options": ["JSON payload containing patient features", "Only a screenshot", "Only the doctor name", "Only a CSS file"], "answer": 0, "explanation": "The request body contains patient features in JSON format.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "What type of HTTP request is used in the sample API call structure?", "options": ["POST request to Azure ML scoring URI", "GET request to random website", "DELETE request to EHR", "PATCH request to Power BI"], "answer": 0, "explanation": "The slide lists a POST request to the Azure ML scoring URI.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Which headers are included in the sample API call?", "options": ["Content-Type and Authorization", "Only Accept-Language", "Only Cookie", "Only Theme"], "answer": 0, "explanation": "The API call includes Content-Type and Authorization headers.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "The response from Azure ML endpoint may include:", "options": ["Prediction, probability, or class label", "Only HTML color", "Only patient password", "Only a file path"], "answer": 0, "explanation": "The response contains model output such as prediction/probability/class label.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "What should the agent do after receiving prediction result?", "options": ["Parse the result inside the workflow", "Ignore it", "Send it to Event Hub as password", "Delete the endpoint"], "answer": 0, "explanation": "The agent must parse and use the model result.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Step 4 testing begins by:", "options": ["Entering sample patient data", "Buying a new laptop", "Printing the slides only", "Closing the API"], "answer": 0, "explanation": "The test workflow starts with sample patient data.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "A timeout from the Azure ML endpoint should be handled by:", "options": ["Error handling and fallback response", "Pretending the result is normal", "Ignoring the patient case", "Skipping monitoring"], "answer": 0, "explanation": "Timeouts require safe error handling.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Which optional extension can make the lab more realistic?", "options": ["EHR API, guideline retrieval, or alert system", "Changing colors only", "Removing authorization", "No validation"], "answer": 0, "explanation": "These optional extensions are listed in the lab architecture summary.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "Which lab deliverable shows the design visually?", "options": ["Agent design diagram", "Cost invoice only", "Theme screenshot", "Raw password file"], "answer": 0, "explanation": "Agent design diagram is one of the deliverables.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "Which lab discussion question focuses on safety?", "options": ["How would you add safety checks before using the output?", "What color is the dashboard?", "How many slides are there?", "Which font is bigger?"], "answer": 0, "explanation": "This is one of the lab discussion questions.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "A real hospital failure scenario could include:", "options": ["Endpoint outage, invalid patient input, privacy breach, or wrong tool call", "Too many flashcards only", "Beautiful UI", "Using dark mode"], "answer": 0, "explanation": "Production failures include API/model/data/security failures.", "topic": "Chapter 3 Advanced", "difficulty": "hard"}, {"q": "In the visual Agentic AI Architecture summary, what should students be able to do?", "options": ["Redraw the core blocks and explain them", "Memorize only the colors", "Ignore MCP", "Only define Power BI"], "answer": 0, "explanation": "The teaching tip says students should redraw it.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "The Healthcare System Flow visual emphasizes that AI connects to hospital systems through:", "options": ["APIs such as FHIR/HL7", "Only paper forms", "Only PowerPoint", "Only the patient phone"], "answer": 0, "explanation": "The visual links app/backend/agent/APIs with EHR/PACS/hospital systems.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "The Azure Cloud Architecture visual should be read as:", "options": ["Ingestion, compute, storage, and model serving", "Only a list of logos", "Only image classification", "Only a billing diagram"], "answer": 0, "explanation": "The teaching tip says to show how data moves across services.", "topic": "Chapter 3 Advanced", "difficulty": "hard"}, {"q": "The MCP Interaction visual can be summarized as:", "options": ["Agent \u2192 MCP \u2192 Tools", "Patient \u2192 printer \u2192 PDF", "Cosmos DB \u2192 no agent", "Power BI \u2192 medication"], "answer": 0, "explanation": "MCP standardizes agent tool invocation.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "The Clinical Workflow Triage visual starts with:", "options": ["Symptoms / patient input", "Cosmos DB cost report", "Model version number", "PowerPoint slide"], "answer": 0, "explanation": "Triage begins from symptoms, then data retrieval, model, decision.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}, {"q": "In the triage example, \u201cChest pain + dizziness\u201d should lead to:", "options": ["Retrieve history, run risk score, route patient", "Directly discharge without checks", "Ignore red flags", "Only show dashboard"], "answer": 0, "explanation": "The visual example shows data retrieval and risk scoring before routing.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "The Multi-Agent System visual uses a tumor board example where agents feed:", "options": ["A central orchestrator", "A random chatbot only", "A cost table", "A static PDF"], "answer": 0, "explanation": "Specialist agents feed a central orchestrator.", "topic": "Chapter 3 Advanced", "difficulty": "medium"}, {"q": "The Lab Pipeline visual includes:", "options": ["Build agent, connect Azure ML, deploy API, test workflow", "Only data cleaning", "Only EHR billing", "Only image zoom"], "answer": 0, "explanation": "The final visual summarizes lab steps.", "topic": "Chapter 3 Advanced", "difficulty": "easy"}];
  D.mcqs = D.mcqs || [];
  extraMCQs.forEach(q => { if (!exists(D.mcqs, 'q', q.q)) D.mcqs.push(q); });
  const extraFlash = [{"front": "Production requirements", "back": "Security + Monitoring + Scalability + Compliance.", "topic": "Chapter 3 Advanced"}, {"front": "Production pipeline", "back": "Input Validation \u2192 Agent \u2192 Monitoring \u2192 Output.", "topic": "Chapter 3 Advanced"}, {"front": "AKS", "back": "Runs containerized microservices and AI agent services at scale; supports auto-scaling and high availability.", "topic": "Azure"}, {"front": "Azure Functions", "back": "Serverless event-driven compute for lightweight tasks triggered by events like new patient data.", "topic": "Azure"}, {"front": "Azure Event Hub", "back": "High-throughput real-time stream ingestion for IoT, wearable, or monitoring data.", "topic": "Azure"}, {"front": "Azure Cosmos DB", "back": "Low-latency NoSQL storage for interactions, context, events, and agent memory.", "topic": "Azure"}, {"front": "Azure AI Services", "back": "Pre-built AI APIs for language, vision, and speech; no training from scratch needed.", "topic": "Azure"}, {"front": "Azure OpenAI Service", "back": "Secure enterprise access to LLMs via API for agent reasoning and response generation.", "topic": "Azure"}, {"front": "Azure Machine Learning", "back": "Build, train, register, version, and deploy custom ML models as endpoints/APIs.", "topic": "Azure"}, {"front": "Scoring URI", "back": "The URL of the deployed Azure ML endpoint that receives prediction requests.", "topic": "Deployment"}, {"front": "JSON payload", "back": "The request body containing patient features sent from the agent to the model API.", "topic": "Deployment"}, {"front": "API headers", "back": "Content-Type + Authorization are needed in the sample Azure ML API call.", "topic": "Deployment"}, {"front": "MCP", "back": "Standardizes how the agent invokes tools and receives structured responses.", "topic": "Agentic AI"}, {"front": "AI + Azure ML + Agents flow", "back": "Train model \u2192 deploy as API \u2192 agent calls via MCP \u2192 use in clinical workflow.", "topic": "Chapter 3 Advanced"}, {"front": "Memory shortcut", "back": "Model predicts, Agent coordinates, LLM explains, Safety validates.", "topic": "Chapter 3 Advanced"}, {"front": "Validation and error handling", "back": "Check missing fields, invalid input, endpoint failures/timeouts, and provide fallback response.", "topic": "Safety"}, {"front": "Lab goal", "back": "Build a simple healthcare AI agent end-to-end.", "topic": "Lab"}, {"front": "Lab prerequisites", "back": "Azure for Students, Azure ML workspace, Python notebook, sample/mock patient data, REST API basics.", "topic": "Lab"}, {"front": "Lab deliverables", "back": "Agent design diagram, working Azure ML endpoint, API integration code, demo, reflection on risks.", "topic": "Lab"}, {"front": "Triage workflow", "back": "Symptoms \u2192 data retrieval \u2192 model \u2192 decision/routing.", "topic": "Clinical Workflow"}];
  D.flashcards = D.flashcards || [];
  extraFlash.forEach(f => { if (!exists(D.flashcards, 'front', f.front)) D.flashcards.push(f); });
  const extraShort = [{"q": "List the four production requirements for a healthcare agentic AI system.", "a": "Security, monitoring, scalability, and compliance. Security protects access and patient data, monitoring tracks failures/performance, scalability handles load, and compliance aligns the system with healthcare rules.", "topic": "Chapter 3 Advanced"}, {"q": "Explain the production pipeline Input Validation \u2192 Agent \u2192 Monitoring \u2192 Output.", "a": "Input validation checks patient data before processing. The agent reasons, plans, and calls tools/models. Monitoring tracks errors, latency, and system health. Output presents a safe prediction, explanation, and next action.", "topic": "Chapter 3 Advanced"}, {"q": "Differentiate AKS and Azure Functions.", "a": "AKS runs containerized microservices and agent services at scale with high availability. Azure Functions runs lightweight serverless tasks triggered by events such as new patient data.", "topic": "Azure"}, {"q": "Differentiate Event Hub and Cosmos DB.", "a": "Event Hub ingests high-throughput real-time streams from devices or systems. Cosmos DB stores low-latency NoSQL data such as interactions, events, context, and agent memory.", "topic": "Azure"}, {"q": "Differentiate Azure OpenAI and Azure Machine Learning.", "a": "Azure OpenAI provides LLMs via API for reasoning and response generation. Azure ML builds, trains, registers, versions, and deploys custom ML models as APIs.", "topic": "Azure"}, {"q": "Explain the workflow: Train model in Azure ML \u2192 Deploy as API \u2192 Agent calls model via MCP.", "a": "The ML model is trained and registered in Azure ML, then deployed as an online endpoint/API. The agent sends a JSON payload through a standardized MCP/tool layer, receives prediction/probability/class label, and uses it in the clinical workflow.", "topic": "Integration"}, {"q": "What is included in a sample Azure ML API call?", "a": "It uses a POST request to the Azure ML scoring URI. Headers include Content-Type and Authorization. The body contains patient features in JSON format. The response returns prediction, probability, or class label.", "topic": "Deployment"}, {"q": "Why are validation and error handling critical in healthcare AI?", "a": "Because missing fields, invalid inputs, endpoint failures, or timeouts can produce unsafe outputs. The agent must detect errors and provide safe fallback responses instead of hallucinating.", "topic": "Safety"}, {"q": "Describe the lab session goal and steps.", "a": "The goal is to build a simple healthcare AI agent end-to-end. Steps: build agent logic, connect to Azure ML, deploy model as API, and test workflow with sample healthcare input.", "topic": "Lab"}, {"q": "What are the lab prerequisites?", "a": "Azure for Students account, Azure Machine Learning workspace, Python notebook environment, sample healthcare dataset or mock patient input, and basic REST API understanding.", "topic": "Lab"}, {"q": "Describe Step 1 \u2014 Build the Agent.", "a": "Define the agent task such as triage assistant or risk prediction assistant, write input/output schema, add simple reasoning logic, and prepare placeholders for external tool calls.", "topic": "Lab"}, {"q": "Describe Step 2 \u2014 Prepare and deploy the Azure ML model.", "a": "Train or load a model in Azure ML, register it, create an inference script, define environment/dependencies, create an online endpoint, deploy the registered model, and obtain scoring URI plus authentication key/token.", "topic": "Lab"}, {"q": "Describe Step 3 \u2014 Connect the agent to Azure ML API.", "a": "Use Python requests or SDK to send a JSON payload from the agent to the endpoint, receive prediction result, and parse it inside the agent workflow.", "topic": "Lab"}, {"q": "What failures can happen in a real hospital setting?", "a": "Invalid patient input, missing fields, endpoint failure, timeout, wrong tool selection, privacy breach, model drift, unclear output, or lack of human review.", "topic": "Production"}, {"q": "How can the lab become a production system?", "a": "Add authentication, EHR/FHIR integration, logging and monitoring, validation rules, fallback handling, compliance checks, scalable deployment with AKS, and human-in-the-loop review.", "topic": "Production"}];
  D.shortAnswers = D.shortAnswers || [];
  extraShort.forEach(s => { if (!exists(D.shortAnswers, 'q', s.q)) D.shortAnswers.push(s); });
  const extraGloss = [{"term": "AKS", "definition": "Azure Kubernetes Service: runs containerized microservices and AI agent services at scale.", "source": "Chapter 3 Advanced"}, {"term": "Azure Functions", "definition": "Serverless event-driven compute for lightweight triggered tasks.", "source": "Chapter 3 Advanced"}, {"term": "Azure Event Hub", "definition": "High-throughput real-time stream ingestion service used for IoT/wearable/monitoring data.", "source": "Chapter 3 Advanced"}, {"term": "Azure Cosmos DB", "definition": "Low-latency NoSQL database for interactions, events, context, and agent memory.", "source": "Chapter 3 Advanced"}, {"term": "Azure OpenAI Service", "definition": "Secure Azure service that provides LLM access through APIs for agent reasoning and response generation.", "source": "Chapter 3 Advanced"}, {"term": "Azure Machine Learning", "definition": "Azure service for building, training, registering, versioning, and deploying custom ML models.", "source": "Chapter 3 Advanced"}, {"term": "Scoring URI", "definition": "The endpoint URL where an Azure ML deployed model receives prediction requests.", "source": "Chapter 3 Advanced"}, {"term": "JSON payload", "definition": "Structured request body sent to an API, containing patient features in the lab workflow.", "source": "Chapter 3 Advanced"}, {"term": "Fallback response", "definition": "Safe response returned when input is invalid, endpoint fails, timeout occurs, or case is unknown.", "source": "Chapter 3 Advanced"}];
  D.glossary = D.glossary || [];
  extraGloss.forEach(g => { if (!exists(D.glossary, 'term', g.term)) D.glossary.push(g); });
})();
